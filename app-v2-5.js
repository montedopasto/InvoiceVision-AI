...
function renderizarDashboardExecutive() {
    ...
    if (msg) {
        msg.textContent = score >= 80
            ? 'Carteira equilibrada, com risco global controlado.'
            : score >= 60
                ? 'Carteira estável, mas com focos que exigem acompanhamento.'
                : score >= 40
